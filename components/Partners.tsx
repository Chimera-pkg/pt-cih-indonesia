export default function Partners() {
  return (
    <section id="mitra" className="py-16 bg-white border-t border-gray-200">
      <div className="container mx-auto px-6 text-center">
        <h4 className="text-gray-400 font-bold uppercase text-sm tracking-widest mb-8">Dipercaya Oleh Mitra Kami</h4>
